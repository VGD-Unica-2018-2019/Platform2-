...
public class ProtagonistController : GameCharacterController
{
    ...
    protected override void Start()
    {
        ...
        _groundVec = new Vector3(groundDistance, 0.2f, groundDistance);
    }
    ...
    protected override void ManageMovement()
    {
        ...
        // a caso qua modifica veloce per aprire il menu e bloccare la partita
    ...
    protected override void ManageJumpAndGravity()
    {
        ...
        _isGrounded = Physics.CheckBox(_groundCheckTransform.position, _groundVec, _groundCheckTransform.rotation, layerToCheck);
    ...
    {
        base.Die();
        StartCoroutine(SceneTransitioner.GetInstance().GoToSceneAfterNSeconds(indexScene: 6, deadAnimationTime));
    }
    ...
    private void OnDrawGizmos()
    {
        ...
        Gizmos.DrawWireCube(_groundCheckTransform.position, new Vector3(groundDistance, 0.2f, groundDistance));
    }
}